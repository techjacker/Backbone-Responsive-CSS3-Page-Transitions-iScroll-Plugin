...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		min: {
			dist: {
				src: ['<banner>', 'backbone.responsiveCSS3transitions.iscroll.js'],
				dest: 'backbone.responsiveCSS3transitions.iscroll.min.js'
			}
		},
		cssmin: {
			css: {
				src: 'backbone.responsiveCSS3transitions.iscroll.css',
				dest: 'backbone.responsiveCSS3transitions.iscroll.min.css'
			}
		},
		lint: {
			files: ['backbone.responsiveCSS3transitions.iscroll.js', 'server.js', 'grunt.js', 'test.js', 'package.json', 'component.json']
		},
		jshint: {
			options: {
				nomen: false,
